     ...
     <div key={post.slug} className="flex flex-col md:flex-row gap-4 items-center">
        ...
        <div>
            ...
            <div className="flex gap-3 items-center mt-3">
                ...
                <Link href="#" aria-label={`view ${post.slug} details`} className="flex gap-2 items-center text-sm hover:gap-3 animate duration-300 text-site-red uppercase">Read more <FaLongArrowAltRight /></Link>
            </div>
        </div>
